...
<div class="container-fluid panel-body" style="padding-bottom:0px">
    <form class="form-horizontal" id="formAdd" action="/login" method="post">
        ...
        <div class="panel panel-default" style="margin-bottom: 0px">
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <input type="text" class="form-control" name="emailAddress" placeholder="电子邮箱">
                    </div>
                </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-1">
                            <a href="/JSP/UserManage.jsp" class="btn btn-primary">返 回</a>
                        </div>
                    </div>
                </form>
            </div>
