        ...
        try {
            ...
            while (resultSet.next()){
                if (id == resultSet.getInt(1)){
                    ...
                    message = new Message(user,friend,resultSet.getString(3),resultSet.getTimestamp(4));
                }else {
                    friend = getUser(findUser,resultSet.getInt(1));
                    message = new Message(friend,user,resultSet.getString(3),resultSet.getTimestamp(4));
                }
